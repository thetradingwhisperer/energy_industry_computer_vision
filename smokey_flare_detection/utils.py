...
def make_inference_normal(image_path, confidence=40):
...
def make_inference_ringelmaan(image_path, confidence=40):
    ...
    #Defining the annotator on the image or video
    label_annotator = sv.LabelAnnotator(text_thickness=0, text_position=sv.Position.BOTTOM_LEFT)
    main_annotator =   sv.ColorAnnotator(opacity=0.3) #sv.MaskAnnotator()
